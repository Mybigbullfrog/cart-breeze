...
class CartalystStripeBillingRenameTheInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::rename('stripe_invoices', 'stripe_invoices_old');
    }
    ...
    {
        Schema::rename('stripe_invoices_old', 'stripe_invoices');
    }
}
