...
class CartalystStripeBillingRecreateTheSubscriptionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stripe_subscriptions', function (Blueprint $table) {
            ...
            $table->string('billing_cycle_anchor')->nullable();
            $table->integer('days_until_due')->nullable()->unsigned();
