...
class CartalystStripeBillingRenameThePaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::rename('stripe_payments', 'stripe_payments_old');
    }
    ...
    {
        Schema::rename('stripe_payments_old', 'stripe_payments');
    }
}
