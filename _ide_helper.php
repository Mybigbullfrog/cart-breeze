...
')
     ...
     */ 
        ...
        public static function getInstance()
        {
                        /** @var \Cartalyst\Cart\Cart $instance */
         ...
         * @static 
         */ 
        public static function getEventDispatcherStatus()
        {
                        /** @var \Cartalyst\Cart\Cart $instance */
                        return $instance->getEventDispatcherStatus();
        }
                    /**
         ...
         * @static 
         */ 
        public static function setEventDispatcherStatus($status)
        {
                        /** @var \Cartalyst\Cart\Cart $instance */
                        $instance->setEventDispatcherStatus($status);
        }
                    /**
         * Fires an event.
         *
...
namespace  { 
            ...
            class Cart extends \Cartalyst\Cart\Laravel\Facades\Cart {}
